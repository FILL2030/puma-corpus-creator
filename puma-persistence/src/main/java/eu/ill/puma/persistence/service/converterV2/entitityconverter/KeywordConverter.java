...
public class KeywordConverter {
	...
	public static Keyword convert(BaseStringEntity importerKeyword) {

		Keyword keyword = new Keyword();

		keyword.setWord(importerKeyword.getValue());
//		if (importerKeyword.getPumaId() != null) {
//			keyword.setId(Math.abs(importerKeyword.getPumaId()));
//		}
