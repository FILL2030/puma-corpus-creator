...
public class ResolverInfoConverter {

	public static ResolverInfo convert(BaseFileToDownload importerFileToDownload) {

		ResolverInfo resolverInfo = new ResolverInfo();
		resolverInfo.setOriginUrl(importerFileToDownload.getUrl());

//		if (importerFileToDownload.getPumaId() != null) {
//			resolverInfo.setId(Math.abs(importerFileToDownload.getPumaId()));
//		}
