...
public class ExtractedDocument {
	...
	public ExtractedDocument(DocumentVersion documentVersion, PumaFileService pumaFileService) {
		...
		for (Instrument instrument : documentVersion.getInstruments()) {
			this.instruments.add(instrument);

			if (instrument.getLaboratory() != null) {
				this.laboratories.add(instrument.getLaboratory());
			}
		}
