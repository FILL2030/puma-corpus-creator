...
public class CancelImportTask extends Task<ImporterOperation>  {

	private ImporterOperation importerOperation;

	public CancelImportTask(ImporterOperation importerOperation) {
		this.importerOperation = importerOperation;
		this.setPriority(TaskPriority.ASAP);
	}

	@Override
	public ImporterOperation execute() throws Exception {
