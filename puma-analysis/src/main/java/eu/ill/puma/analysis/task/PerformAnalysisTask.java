...
public class PerformAnalysisTask extends Task<DocumentVersion>  {

	private AnalyserManager analyserManager;
	private DocumentVersion documentVersion;

	public PerformAnalysisTask(AnalyserManager analyserManager, DocumentVersion documentVersion) {
	...
	public DocumentVersion execute() throws Exception {
		this.analyserManager.performAnalysis(this.documentVersion);
