...
public class PerformAnalysisListTask extends Task<List<Long>>  {

	private AnalyserManager analyserManager;
	private List<Long> documentVersionIds;

	public PerformAnalysisListTask(AnalyserManager analyserManager, List<Long> documentVersionIds) {
	...
	public List<Long> execute() throws Exception {
		this.analyserManager.addDocumentVersionsToAnalyse(this.documentVersionIds, null);

		return this.documentVersionIds;
	}
}
